      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11225&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lenskit-feedstock?branchName=main&jobName=linux&configuration=linux%20linux_aarch64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_64</td>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11225&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lenskit-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>win_64</td>
...
Once the `conda-forge` channel has been enabled, `lenskit, lenskit-gnn, lenskit-hpf, lenskit-implicit, lenskit-sklearn, lenskit-tune` can be installed with `conda`:

```
conda install lenskit lenskit-gnn lenskit-hpf lenskit-implicit lenskit-sklearn lenskit-tune
```

or with `mamba`:

```
mamba install lenskit lenskit-gnn lenskit-hpf lenskit-implicit lenskit-sklearn lenskit-tune
```
